export const UI = {
  ...
  input:
    "px-4 py-3 bg-[var(--bg-hover)] rounded-xl text-sm font-bold outline-none text-[var(--text-main)] border cms-border focus:border-[var(--accent)] transition w-full",
  btnTool:
  ...
  iconBtn:
    "p-1.5 opacity-60 hover:opacity-100 bg-[var(--bg-hover)] hover:bg-[var(--border)] rounded transition",
};
